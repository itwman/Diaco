$(document).ready(function () {
  $("#myButton").click(function () {
    $.blockUI({
      message:
        '<div class="loader-container-box"><div class="loader"></div></div>',
      timeout: 3000,
      overlayCSS: {
  ...
  $("#myButton4").on("click", function () {
    ...
    window.setTimeout(function () {
      message.html('<div class="mutiple-msg"> بارگزاری ...</div>');
    }, 0);

    window.setTimeout(function () {
      message.html('<div class="mutiple-msg">صبور  باشید...</div>');
    }, 4000);
  ...
  $("#myButton5").click(function () {
    $(".block-msg-animation-card").block({
      message:
        '<div class="bolckui-msg-box"><div class="loader-container-box"><div class="loader"></div></div></span>&nbsp; بارگزاری ...</div>',
      timeout: 3000,
      overlayCSS: {
        backgroundColor: "rgba(var(--dark), 0.8)",
        opacity: 0.8,
  ...
  $("#myButton6").click(function () {
    $(".unblock-callback").block({
      ...
      onUnblock: function () {
        alert("صفحه از حالت قفل خارج شد");
      },
    });
  });
  ...
  $("#myButton7").click(function () {
    $(".block-callback").block({
      ...
      onBlock: function () {
        alert("صفحه در حالت قفل قرار گرفت.");
      },
    });
  });
