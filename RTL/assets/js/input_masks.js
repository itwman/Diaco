...
const timeInputs = [".time-input", ".min-sec-input", ".hours-min-input"];
...
timeInputs.forEach((selector) => {
  try {
    new Cleave(selector, {
      time: true,
      timePattern:
        selector === ".min-sec-input" || selector === ".hours-min-input"
          ? ["h", "m"]
          : ["h", "m", "s"],
    });
  } catch (err) {
...
const customInputs = [
  ...
  {
    selector: ".numeral-input",
    options: { numeral: true, numeralThousandsGroupStyle: "thousand" },
  },
  {
    selector: ".price-input",
    options: { numeral: true, prefix: "$", signBeforePrefix: true },
  },
  {
    selector: ".price-formatting",
    options: { numeral: true, prefix: "€", tailPrefix: true },
  },
  {
    selector: ".prefix-input",
    options: { blocks: [6, 3, 3, 3], prefix: "253874" },
  },
  {
