...
const pond = FilePond.create(document.querySelector(".filepond-file"), {
  labelIdle: `<i class="fa-solid fa-cloud-upload fa-fw fs-4"></i> <div class="filepond--label-action text-decoration-none">فایلهای خود را آپلود کنید</div>`,
});
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  followButton.addEventListener("click", () => {
    ...
    followButton.innerHTML = isFollowing
      ? '<i class="ti ti-user-check"></i> دنبال کننده'
      : '<i class="ti ti-user"></i> دنبال کنید';
