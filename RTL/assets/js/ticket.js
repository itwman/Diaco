    ...
    <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="h-30 w-30 d-flex-center b-r-50 overflow-hidden text-bg-primary ms-2">
                            ...
                            <td> <span class="badge text-outline-warning">${$(
                              "#priority"
                            ).val()}</span></td>
                            <td>${$("#titlename").val()}</td>
                            <td><span class="badge text-outline-primary">${$(
                              "#status"
                            ).val()}</span></td>
                            ...
                            <td>
                                <div class="btn-group dropdown-icon-none">
                                    ...
                                    <li><a class="dropdown-item" href="./ticket_details.html"><i
                                                    class="ti ti-eye text-primary ms-2"></i> نمایش </a></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                        data-bs-target="#ticketeditModal"><i
                                                    class="ti ti-edit text-success ms-2"></i> ویرایش </a></li>
                                        <li ><a class="dropdown-item delete-btn" href="#" data-bs-toggle="modal"><i
                                                    class="ti ti-trash text-danger ms-2"></i> حذف </a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
