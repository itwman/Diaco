...
const pie1Options = {
  ...
  labels: ["تیم آ", "تیم ب", "تیم ث", "تیم د", "تیم ر"],
  legend: {
    position: "bottom",
  },
  responsive: [
...
const pie9Options = {
  ...
  labels: ["دستگاه 1", "دستگاه 2", "دستگاه 3", "دستگاه 4"],
  colors: [
    getLocalStorageItem("color-primary", "#0F626A"),
    getLocalStorageItem("color-secondary", "#626262"),
    "#0AB964",
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const appendData = () => {
    ...
    const labels = pie9OChart.w.globals.labels;
    labels.push("دستگاه");
    pie9OChart.updateOptions({
      labels: labels,
    });
  ...
  addBtn?.addEventListener("click", () =>
    pie9OChart.updateSeries(appendData())
  );
  removeBtn?.addEventListener("click", () =>
    pie9OChart.updateSeries(removeData())
  );
  resetBtn?.addEventListener("click", () => {
    pie9OChart.updateOptions({
      labels: ["دستگاه 1", "دستگاه 2", "دستگاه 3", "دستگاه 4"],
    });
    pie9OChart.updateSeries(reset());
  });
});
...
const polarOptions = {
  ...
  labels: ["دستگاه 1", "دستگاه 2", "دستگاه 3", "دستگاه 4", "دستگاه 5"],
  height: 600,
  chart: {
    fontFamily: "Vazirmatn FD,Rubik, serif",
    type: "polarArea",
...
const polarChart = new ApexCharts(
  document.querySelector("#polar1"),
  polarOptions
);
polarChart.render();
...
const chart4Chart = new ApexCharts(
...
const chart5Chart = new ApexCharts(
