...
taskOverviewChart = new ApexCharts(
...
taskOverviewChart1 = new ApexCharts(
  document.querySelector("#taskOverview1"),
  taskOverviewOptions1
);
...
taskOverviewChart2 = new ApexCharts(
  document.querySelector("#taskOverview2"),
  taskOverviewOptions2
);
...
const audienceChartOptions = {
  ...
  labels: ["18 - 24 سال", "25 - 40 سال", "40 - 55 یال", "55+ سال"],
  colors: [
    "rgba(var(--primary),1)",
    "rgba(var(--primary),.8)",
    "rgba(var(--primary),.6)",
...
const profitOverviewChart = new ApexCharts(
