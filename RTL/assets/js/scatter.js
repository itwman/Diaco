...
const scatter1Chart = new ApexCharts(
  document.querySelector("#scatter1"),
  scatter1ChartOptions
);
...
const scatter2Chart = new ApexCharts(
  document.querySelector("#scatter3"),
  scatter2ChartOptions
);
