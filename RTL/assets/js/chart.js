...
// Chart.defaults.global.defaultFontFamily = "Vazirmatn FD,Rubik, serif";
Chart.defaults.font.family = "Vazirmatn FD,Rubik, serif";
  ...
  data: {
    ...
    datasets: [
      ...
      },
      {
        label: "دیتاست  #2",
        backgroundColor: hexToRGB(
          getLocalStorageItem("color-primary", "#0AB964"),
          0.2
        ),
        borderColor: hexToRGB(
          getLocalStorageItem("color-primary", "#0AB964"),
  ...
  data: {
    ...
    datasets: [
      ...
      },
      {
        label: "دیتاست  #2",
        backgroundColor: hexToRGB(
          getLocalStorageItem("color-danger", "#E14E5A"),
          0.2
        ),
        borderColor: hexToRGB(
          getLocalStorageItem("color-danger", "#E14E5A"),
    ...
    datasets: [
      {
        label: "دیتاست  #1",
        backgroundColor: hexToRGB(
          getLocalStorageItem("color-success", "#0AB964"),
          0.2
        ),
        borderColor: hexToRGB(
          getLocalStorageItem("color-success", "#0AB964"),
...
new Chart(chart8, {
  ...
  data: {
    ...
    datasets: [
      {
        backgroundColor: [
          hexToRGB(getLocalStorageItem("color-secondary", "#0F626A"), 0.1),
          hexToRGB(getLocalStorageItem("color-secondary", "#0F626A")),
        ],
        data: [21, 79],
      },
      {
        backgroundColor: [
          ...
          hexToRGB(getLocalStorageItem("color-success", "#626262")),
        ],
        data: [33, 67],
      },
      {
        backgroundColor: [
          hexToRGB(getLocalStorageItem("color-primary", "#0AB964"), 0.5),
          hexToRGB(getLocalStorageItem("color-primary", "#0AB964"), 1),
        ],
        data: [20, 80],
      },
      {
