...
const radialBar1chart = new ApexCharts(
  document.querySelector("#radial-bar1"),
  radialBar1Options
);
...
const radialBar2Chart = new ApexCharts(
  document.querySelector("#radial-bar2"),
  radialBar2Options
);
...
const radialBar3Chart = new ApexCharts(
  document.querySelector("#radial-bar3"),
  radialBar3Options
);
...
const radialBar5Chart = new ApexCharts(
  document.querySelector("#radial-bar5"),
  radialBar5Options
);
...
const radialBar6Chart = new ApexCharts(
  document.querySelector("#radial-bar6"),
  radialBar6Options
);
...
const radialBar7Chart = new ApexCharts(
  document.querySelector("#radial-bar7"),
  radialBar7Options
);
...
const radialBar8Chart = new ApexCharts(
  document.querySelector("#radial-progress18"),
  radialBar8Options
);
...
const radialBar19Chart = new ApexCharts(
  document.querySelector("#radial-progress19"),
  radialBar19Options
);
...
const radialBar20Chart = new ApexCharts(
  document.querySelector("#radial-progress20"),
  radialBar20Options
);
...
const radialBar21Chart = new ApexCharts(
  document.querySelector("#radial-progress21"),
  radialBar21Options
);
...
const radialBar22Chart = new ApexCharts(
  document.querySelector("#radial-progress22"),
  radialBar22Options
);
...
const radialBar23Chart = new ApexCharts(
  document.querySelector("#radial-progress23"),
  radialBar23Options
);
...
const radialBar24Chart = new ApexCharts(
  document.querySelector("#radial-progress24"),
  radialBar24Option
);
