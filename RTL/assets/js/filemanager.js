...
const polar2Chart = new ApexCharts(
  document.querySelector("#polar2"),
  polar2Options
);
polar2Chart.render();
    ...
    button.addEventListener("click", () => {
      try {
        ...
        confirmButton.onclick = () => {
          ...
          document
            .querySelector(".documents-sections .card-body .row")
            .appendChild(container.cloneNode(true));
          container.remove();
          modal.modal("hide");
    ...
    icon.addEventListener("click", function (event) {
      try {
        ...
        if (event.target.classList.contains("ph-fill")) {
          document
            .querySelector("#tab-2 .row")
            .appendChild(favBtn.cloneNode(true));
        } else {
    ...
    <td class="d-flex">
      <div class="dropdown folder-dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item view-item-btn" href=""><i class="ti ti-file-export"></i> نمایش</a></li>
          <li><a class="dropdown-item edit-folder-list" href="" data-bs-toggle="modal" role="button"><i class="ti ti-edit"></i> ویرایش</a></li>
          <li><a class="dropdown-item" href="" data-bs-toggle="modal" role="button"><i class="ti ti-trash"></i> حذف</a></li>
        </ul>
      </div>
    ...
    <div class="card">
      <div class="card-body folder-card">
        ...
        <div class="dropdown folder-dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item view-item-btn" href=""><i class="ti ti-file-export text-primary"></i> نمایش</a></li>
            <li><a class="dropdown-item edit-folder-list" href="" data-bs-toggle="modal" role="button"><i class="ti ti-edit text-success"></i> ویرایش</a></li>
            <li><a class="dropdown-item delete-btn" href="" data-bs-toggle="modal" role="button"><i class="ti ti-trash text-danger"></i> حذف</a></li>
          </ul>
        </div>
        ...
        <div class="d-flex justify-content-between">
          <p class="f-s-12 text-secondary">25.67 گیگ</p>
          <p class="f-s-12 text-secondary text-end">50 گیگ</p>
        </div>
      </div>
    </div>
  </div>`;
