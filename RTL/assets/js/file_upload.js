...
function setupPond(selector, options = {}) {
  try {
    ...
    if (el) {
      FilePond.create(el, {
        labelIdle: `<i class="fa-solid fa-cloud-upload fa-fw f-s-60 text-secondary"></i> <div class="filepond--label-action text-decoration-none">آپلود فایل</div>`,
        ...options,
      });
    }
  } catch (err) {
...
[
  ...
  const options = id.startsWith("filepond")
    ? {
        labelIdle: `<i class="fa-solid fa-cloud-upload fa-fw f-s-10 text-secondary"></i> <div class="filepond--label-action text-decoration-none">آپلود فایل</div>`,
        imagePreviewHeight: 170,
        imageCropAspectRatio: "1:1",
        imageResizeTargetWidth: 100,
        imageResizeTargetHeight: 100,
    ...
    : {
        labelIdle: `<i class="fa-solid fa-cloud-upload fa-fw f-s-25"></i> <div class="filepond--label-action text-decoration-none">آپلود فایل</div>`,
      };
