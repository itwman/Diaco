...
function projectCardContent() {
  ...
  return `
           ...
           <div class="card-header">
             <div class="d-flex align-items-center">
               <div>
                 ...
                 } alt="image" class="h-40 w-40 d-flex-center b-r-50 overflow-hidden" id="preview">
               </div>
               <a href="project_details.html" target="_blank" class="flex-grow-1 ps-2">
                 <h6 class="m-0 f-w-600">${$("#pName").val()}</h6>
                 <div class="text-muted f-s-14">مدیریت</div>
               </a>
               <div class="dropdown">
                 ...
                 <ul class="dropdown-menu dropdown-menu-end">
                   <li>
                     <a class="dropdown-item" href="#">
                       <i class="ti ti-edit text-success"></i> ویرایش
                     </a>
                   </li>
                   <li>
                     <a class="dropdown-item delete-button" href="#">
                       <i class="ti ti-trash text-danger"></i> حذف
                     </a>
                   </li>
                 </ul>
               </div>
           ...
           <div class="card-body">
             <div class="d-flex">
               <div>
                 <h6 class="text-dark f-s-14">تاریخ شروع : <span class="text-success">${$(
                   "#startDate"
                 ).val()}</span></h6>
                 <h6 class="text-dark f-s-14">تاریخ پایان : <span class="text-danger">${$(
                   "#endDate"
                 ).val()}</span></h6>
               </div>
               <div class="flex-grow-1 text-end">
                 <p class="f-w-500 text-secondary">قیمت </p>
                 <h6 class="f-w-600">${$("#pricing").val()}</h6>
               </div>
             </div>
             <p class="text-muted f-s-14 text-secondary">${$(
               "#projectDescription"
             ).val()}</p>
             <div class="text-end mb-2" >
               <span class="badge text-light-primary">پیشرفت</span>
             </div>
